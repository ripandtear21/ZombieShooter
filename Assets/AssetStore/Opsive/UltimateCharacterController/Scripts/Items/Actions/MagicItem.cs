...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class MagicItem : UsableItem
    {
        ...
        [Tooltip("Unity event invoked when there is an impact.")]
        [SerializeField] protected UnityItemRaycastHitSurfaceImpactEvent m_OnImpactEvent;
        ...
        public int MaxCollisionCount { get { return m_MaxCollisionCount; } set { m_MaxCollisionCount = value;
                if (m_TargetColliders != null) {
                    System.Array.Resize(ref m_TargetColliders, m_MaxCollisionCount);
                    System.Array.Resize(ref m_TargetAngles, m_MaxCollisionCount);
                }
            } }
        ...
        public UnityItemBoolBoolEvent OnStartStopBeginEndActionsEvent { get { return m_OnStartStopBeginEndActionsEvent; } set { m_OnStartStopBeginEndActionsEvent = value; } }
        public UnityItemEvent OnCastEvent { get { return m_OnCastEvent; } set { m_OnCastEvent = value; } }
        public UnityItemRaycastHitSurfaceImpactEvent OnImpactEvent { get { return m_OnImpactEvent; } set { m_OnImpactEvent = value; } }
        ...
        public void StartStopBeginEndActions(bool beginActions, bool start, bool networkEvent)
        {
            ...
            EventHandler.ExecuteEvent(m_Character, "OnMagicItemStartStopBeginEndActions", m_Item, beginActions, start);
            if (m_OnStartStopBeginEndActionsEvent != null) {
                m_OnStartStopBeginEndActionsEvent.Invoke(m_Item, beginActions, start);
            }
        }
                ...
                if (!actionsCasted) {
                    ...
                    for (int i = 0; i < useCount; ++i) {
                        ...
                        for (int j = 0; j < m_CastActions.Length; ++j) {
                            ...
                            // Notify those interested that the magic item has cast an action.
                            if (!castEvent) {
                                EventHandler.ExecuteEvent(m_GameObject, "OnMagicItemCast", m_Item);
                                if (m_OnCastEvent != null) {
                                    m_OnCastEvent.Invoke(m_Item);
                                }
                                castEvent = true;
                            }
                        }
        ...
        public void PerformImpact(uint castID, GameObject source, GameObject target, RaycastHit hit)
        {
            ...
            EventHandler.ExecuteEvent(target, "OnMagicItemImpact", hit, m_SurfaceImpact);
            EventHandler.ExecuteEvent(m_Character, "OnMagicItemImpact", m_Item, hit, m_SurfaceImpact);
            if (m_OnImpactEvent != null) {
                m_OnImpactEvent.Invoke(m_Item, hit, m_SurfaceImpact);
            }
        }
